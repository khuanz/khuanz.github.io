...
(function e$$0(x, z, l) {
  ...
  for (
    var g = "function" == typeof require && require, w = 0;
    w < l.length;
    w++
  )
    h(l[w]);
        ...
        A = (function () {
          ...
          function p() {
            this.vboxes = new g(function (f, c) {
              return l.naturalOrder(
                f.vbox.count() * f.vbox.volume(),
              ...
              for (k = c[f]; k <= c[a]; k++)
                if (y[k] > n / 2) {
                  ...
                  for (
                    v =
                      v <= d
                        ? Math.min(c[a] - 1, ~~(k + d / 2))
                        : Math.max(c[f], ~~(k - 1 - v / 2));
                    !y[v];
            ...
            function b(a, b, d) {
              ...
              for (g = 0; g < m; )
                (e = 4 * g),
                  ...
                  (e = r[e + 3]),
                  125 <= e &&
                    ((250 < q && 250 < c && 250 < f) || a.push([q, c, f])),
                  (g += d);
